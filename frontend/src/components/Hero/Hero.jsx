...
const Hero = ({ onSectionChange }) => {
  ...
  const block = [
    <SectionWrapper id="about" title="About" terminalCommand="whoami">
  ...
  const cond_block = [
    <SectionWrapper id="education" title="Education" terminalCommand="echo $education">
      <Education eduData={details['education']} />
    </SectionWrapper>
    ,
    <SectionWrapper id="experience" title="Experience" terminalCommand="echo $experience">
      <Experience expData={details['experience']} />
    </SectionWrapper>
    ,
    <SectionWrapper id="projects" title="Projects" terminalCommand="echo $projects">
      <Projects />
    </SectionWrapper>
    ,
    <SectionWrapper id="skills" title="Skills" terminalCommand="ls -l $skills">
      <Skills skillData={details['skills']} />
    </SectionWrapper>
    ,
    <SectionWrapper id="interest" title="Interest" terminalCommand="cat $interest">
      <Interest Interest={details['interest']} />
    </SectionWrapper>
    ,
    <SectionWrapper id="contact" title="Contact" terminalCommand="ssh reachout@krishna">

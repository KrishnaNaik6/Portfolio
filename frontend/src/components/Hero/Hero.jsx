...
const Hero = ({ onSectionChange }) => {
  ...
  }, [Show, onSectionChange]);

  const block = [
    <section id="about" className="easeElem anim_sec wai" key="about">
      <h3 ref={ref7} className={`border-animate ${inView7 ? "show" : ""}`}>
  ...
  const cond_block = [
    <section id="education" className="anim_sec educ" key="education">
      <h3 ref={ref1} className={`border-animate ${inView1 ? "show" : ""}`}>
    ...
    <section id="experience" className="anim_sec exp" key="experience">
      <h3 ref={ref3} className={`border-animate ${inView3 ? "show" : ""}`}>
    ...
    <section id="projects" className="anim_sec proj_div" key="projects">
      <h3 ref={ref2} className={`border-animate ${inView2 ? "show" : ""}`}>
        ~\KrishnaNaik6{'>'} echo $projects
      </h3>
      <Projects />
    </section>,
    <section id="skill" key="skills">
      <h3 ref={ref4} className={`border-animate ${inView4 ? "show" : ""}`}>
        ~\skills{'>'} ls
      </h3>
      <Skills skillData={details['skills']} />
    </section>,
    <section id="interest" key="interest">
      <h3 ref={ref6} className={`border-animate ${inView6 ? "show" : ""}`}>
        Interest
      </h3>
      <Interest Interest={details['interest']} />
    </section>,
    <section id="contact" key="contact">
      <h3 ref={ref5} className={`border-animate ${inView5 ? "show" : ""}`}>
        Reach Out
      </h3>
